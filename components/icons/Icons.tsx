...
export const SparkleIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M10.868 2.884c.321-.772 1.433-.772 1.754 0l2.092 5.047a.75.75 0 00.564.41l5.568.81a.75.75 0 01.416 1.28l-4.028 3.926a.75.75 0 00-.217.665l.95 5.543a.75.75 0 01-1.088.791L10 16.347l-4.994 2.624a.75.75 0 01-1.088-.79l.95-5.543a.75.75 0 00-.217-.665L.24 10.43a.75.75 0 01.416-1.28l5.568-.81a.75.75 0 00.564-.41L9.132 2.884z" clipRule="evenodd" />
  </svg>
);
